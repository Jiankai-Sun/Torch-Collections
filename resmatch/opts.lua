...
function M.parse (arg)
   ...
   cmd:option('-imgl', '000000_10', 'Left image')
   cmd:option('-imgr', '000000_10', 'Right image')
   ...
   cmd:option('-mcnet', '../pretrained/kitti_resmatch_fast_LL_rgb_all_net.t7', 'Path to MC trained network')
